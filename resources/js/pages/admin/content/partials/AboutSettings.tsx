        ...
        <form onSubmit={submit}>
            <Card className="border-sidebar-border/70 shadow-sm">
                <CardHeader>
                    ...
                    <CardDescription>
                        Modifiez la section de présentation, incluant les images au survol.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border border-sidebar-border rounded-lg bg-muted/10">
                        <div className="space-y-2">
                            <Label htmlFor="default_images">Images par défaut (premier plan)</Label>
                            <Input
                                id="default_images"
                                type="file"
                                multiple
                                accept="image/*"
                                onChange={(e) => setData('default_images', e.target.files)}
                            />
                            <p className="text-xs text-muted-foreground">Sélectionnez 2 images.</p>
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="hover_images">Images alternatives (au survol)</Label>
                            <Input
                                id="hover_images"
                                type="file"
                                multiple
                                accept="image/*"
                                onChange={(e) => setData('hover_images', e.target.files)}
                            />
                            <p className="text-xs text-muted-foreground">Sélectionnez les 2 images qui s'afficheront au survol.</p>
                        </div>
                    </div>
                </CardContent>
